# Story words the reader can't gloss
...
### name (42)
juan, timprano, sigi, opo, pagkaaga, uu, nay, nahingalimot, ginsigawan, iksakto, pagkaada, television, pagmantene, wusssssss, umandar, kamalipog, yeheey, brown, wow, nasubo, gin-apresyar, gin-raut, ginpinsar, aanhun, dumiritso, ginpapakaun, yehey, susugton, hmmmmm, apisar, mantiw, sayod, umagi, determinado, mahahanaw, nahano, amanhan, nahinumdon, paghiling, totoo … +2

## INFLECTED — we have the root, the reader just doesn't show it (609)
_A stem-gloss fallback would fix all of these for free. (e.g. `bumaton` → `baton`.)_

| word | →root | #stories | freq |
|------|-------|:--:|--:|
| gintatawag | tawag | 8 | 11 |
| naaro | aro | 8 | 8 |
| nabanhaw | banhaw | 7 | 15 |
| sinaka | saka | 7 | 8 |
| pagsunod | sunod | 7 | 8 |
| susumat | sumat | 7 | 7 |
| kaupaya | upaya | 7 | 7 |
...
| silotan | silot | 7 | 7 |
| makadi | kadi | 7 | 7 |
| nagpakatawo | katawo | 7 | 7 |
| pasaylo-a | asay | 7 | 7 |
| magkayaon | kaya | 7 | 7 |
| makaupod | kaupod | 7 | 7 |
| kahangtoran | kaha | 7 | 7 |
| paki | pak | 7 | 7 |
| naging | nagin | 5 | 8 |
| nahitabo | hitabo | 4 | 7 |
| nagpakita | kita | 4 | 5 |
| siton | iton | 4 | 5 |
| nagpakadto | kadto | 4 | 4 |
| sumatan | sumat | 3 | 5 |
| paglabay | laba | 3 | 4 |
| nagkakanta | kanta | 3 | 4 |
| makaharadok | kaha | 3 | 4 |
| bumaton | baton | 3 | 3 |
| pagkita | kita | 3 | 3 |
| pagkahuman | kahuman | 3 | 3 |
| gindadayaw | ayaw | 3 | 3 |
| lumupad | lupad | 3 | 3 |
| maalam | alam | 3 | 3 |
| nagsugad | sugad | 3 | 3 |
...
| kakaunon | kaunon | 2 | 3 |
| mapatay | patay | 2 | 3 |
| magtaralwas | agta | 2 | 3 |
| nakagmata | mata | 2 | 2 |
| pagpasalamat | sala | 2 | 2 |
| hinigdaan | higdaan | 2 | 2 |
| ginhatag | hatag | 2 | 2 |
| nahimangno | himangno | 2 | 2 |
| nagsasarayaw | ayaw | 2 | 2 |
| nagpasalamat | salamat | 2 | 2 |
| ginhigugma | higugma | 2 | 2 |
| nagtangis | tangis | 2 | 2 |
| kadadamo | damo | 2 | 2 |
| ginpasaylo | pasaylo | 2 | 2 |
| nagpabilin | bilin | 2 | 2 |
| pagkagab-i | gab-i | 2 | 2 |
| nagdesisyon | desisyon | 2 | 2 |
| pinakamaopay | pakamaupay | 2 | 2 |
| nagsusumat | sumat | 2 | 2 |
| bungtod | bungto | 2 | 2 |
| nagkamayaon | mayaon | 2 | 2 |
| kamananampan | mana | 2 | 2 |
| nagkamayada | mayad | 2 | 2 |
| maghahadi | hadi | 2 | 2 |
| mamamatay | mamatay | 2 | 2 |
