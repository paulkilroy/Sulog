...
_4 phases · 36 units · 70 lessons · 556 items_

_Generated from src/courses/waray/frequency.js + cards.js. Each item: **waray** — english. (✗ = no card yet.)_

---

## Say something real  ·  _Speak from day one_  (8 units)
...
- _When you're stuck:_  **Waray ako makabaro** — I don't understand  ·  **Naintindihan ko** — I understand  ·  **Diri ako maaram** — I don't know  ·  **Buligi daw ako** — Please help me  ·  **Pasaylo-a ako** — Excuse me / sorry  ·  **Hain an CR?** — Where is the CR? (bathroom)  ·  **Karuyag ko** — I want  ·  **Gusto ko** — I like  ·  **Nakikit-an mo?** — Can you see it?  ·  **Klaro?** — Is it clear?

### Say who's who  — _ako, ikaw, hiya, kita…_
- _The pronouns:_  **ako** — I  ·  **ikaw / ka** — you  ·  **hiya** — he / she  ·  **kita** — we (inclusive)  ·  **kami** — we (exclusive)  ·  **kamo** — you / y'all  ·  **hira** — they  ·  **Amerikano ako** — I am American  ·  **Babaye ka** — You are a woman  ·  **Makusog hiya** — He is strong

### Name what you see  — _hi / an / it — point and name_
- _The little markers:_  **hi** — the (before a name)  ·  **hin** — a / some (object)  ·  **han** — of / the (past object)  ·  **ha** — to / at / in  ·  **ngan** — and  ·  **saging** — banana
- _Markers in sentences:_  **Ako hi Peter** — I am Peter  ·  **Hira Perla ngan Tessie** — They are Perla and Tessie  ·  **Mapalit ako hin saging** — I'll buy a banana  ·  **Makadto ako ha balay** — I'll go to the house

### This & that  — _ini, iton, adto_
- _This, that, over there:_  **ini** — this (near)  ·  **iton** — that (near you)  ·  **adto** — that (over there)  ·  **kahoy** — tree  ·  **libro** — book
- _This / that + noun:_  **ini nga babaye** — this woman  ·  **iton nga lalake** — that man  ·  **adto nga bata** — that child over there  ·  **Tubig ini** — This is water  ·  **Kahoy adto** — That's a tree over there  ·  **Mga libro ini** — These are books
...
## Put words together  ·  _Build real sentences_  (11 units)

### Say what's yours  — _ko / nakon, mo / nimo…_
- _Possessive forms:_  **nakon** — my  ·  **ko** — my (short)  ·  **nimo** — your  ·  **niya** — his / her  ·  **naton** — our (incl)  ·  **namon** — our (excl)  ·  **niyo** — your (pl)  ·  **nira** — their
- _Whose is it?:_  **libro nakon** — my book  ·  **lapis nimo** — your pencil  ·  **uyab niya** — his / her sweetheart  ·  **balay namon** — our house

### Say it's mine  — _akon, imo, iya…_
...
### Do it: now / will / did  — _will / now / did (ma- / na- / -inm-)_
- _Eat & go:_  **makaon** — will eat  ·  **nakaon** — is eating  ·  **kinmaon** — ate  ·  **malakat** — will go  ·  **nalakat** — is going  ·  **linmakat** — went
...
- _Around the house:_  **laba** — to wash (clothes)  ·  **hugas** — to wash (dishes)  ·  **luto** — to cook  ·  **limpyu** — to clean  ·  **lukot** — to fold (clothes)  ·  **basa** — to read  ·  **sudlay** — to comb  ·  **sayaw** — to dance  ·  **maneho** — to drive  ·  **tago** — to hide
- _Common verbs:_  **hatag** — to give  ·  **lingkod** — to sit  ·  **tindog** — to stand  ·  **hulat** — to wait  ·  **dara** — to bring  ·  **andam** — to get ready  ·  **hangyo** — to ask a favor  ·  **labay** — to pass by  ·  **hulam** — to borrow  ·  **bayad** — to pay
...
### Name colors  — _Basic colors_
- _Colors:_  **itom** — black  ·  **busag** — white  ·  **pula** — red  ·  **asul** — blue  ·  **darag** — yellow  ·  **berde** — green

---

## Daily life & people  ·  _Describe your world_  (7 units)
...
### Days & months  — _The week and the year_
- _Days of the week:_  **Lunes** — Monday  ·  **Martes** — Tuesday  ·  **Miyerkoles** — Wednesday  ·  **Huwebes** — Thursday  ·  **Biyernes** — Friday  ·  **Sabado** — Saturday  ·  **Dominggo** — Sunday
- _Months:_  **Enero** — January  ·  **Pebrero** — February  ·  **Marso** — March  ·  **Abril** — April  ·  **Mayo** — May  ·  **Hunyo** — June  ·  **Hulyo** — July  ·  **Agosto** — August  ·  **Setyembre** — September  ·  **Oktubre** — October  ·  **Nobyembre** — November  ·  **Disyembre** — December

### Talk about the weather  — _Talking about the day_
- _Weather:_  **uran / mauran** — rain / rainy  ·  **sirak / masirak** — sun ray / sunny  ·  **dampog / madampog** — clouds / cloudy  ·  **hangin / mahangin** — wind / windy  ·  **mapaso** — hot  ·  **matugnaw** — cold  ·  **may bagyo** — there is a storm  ·  **mapaso hin duro** — very hot  ·  **Kumusta it panahon?** — How is the weather?

### Invite someone out  — _Asking someone over_
- _What's going on?:_  **imbitasyon** — invitation  ·  **may / mayda** — there is / I have  ·  **gin-iimbita** — being invited  ·  **Ano it mayda?** — What's going on?  ·  **May libre ka ba nga oras hit Sabado?** — Do you have free time on Saturday?  ·  **Ano nga oras?** — What time?  ·  **Alas sais ha gab-i** — At 6 in the evening  ·  **Nag-arog ako** — I prepared food  ·  **Mayda pangaon ha balay** — There is food at home  ·  **makadto** — will go to
- _Bring someone & meet:_  **Poydi ko ba ig-upod hi Rey?** — Can I bring Rey along?  ·  **ig-upod** — to bring along  ·  **Siyempre, poydi** — Of course, you can  ·  **Maghuhulat ako ha iyo** — I will wait for you all  ·  **Sigurado, makadto kami** — Sure, we'll come  ·  **Sige, magkita kita hit Sabado** — Okay, let's meet on Saturday  ·  **magkita** — to meet

---

## Out in the world & beyond now  ·  _Travel, errands, past & future_  (10 units)

### Make travel plans  — _Time spans and arriving_
- _Time & travel:_  **biyahe** — trip / travel  ·  **semana** — week  ·  **adlaw** — day  ·  **maabot** — will arrive  ·  **lumakat** — left / departed  ·  **san-o** — when  ·  **kakan-o** — when (past)
- _Saying when:_  **Mabiyahe ako ha Pilipinas** — I'll travel to the Philippines  ·  **Ano ka nga adlaw maabot?** — What day will you arrive?  ·  **Kakan-o ka umabot?** — When did you arrive?  ·  **Hit maabot nga duha ka semana** — In the coming two weeks

### Shop at the market  — _At the market_
- _At the market:_  **tindahan** — store  ·  **tindera** — vendor  ·  **kahera** — cashier  ·  **kwarta** — money  ·  **sukli** — change  ·  **sinsilyo** — coins  ·  **barato** — cheap  ·  **bulad** — dried fish  ·  **tinapa** — smoked fish
...
- _Airport words:_  **eroplano** — airplane  ·  **tiket** — ticket  ·  **bagahe** — baggage  ·  **gate** — gate  ·  **kostums** — customs  ·  **pasaporte** — passport  ·  **pasahero** — passenger
- _At the counter:_  **Pakitaa ako hit imo tiket** — Please show me your ticket  ·  **Pakitaa ako hit imo pasaporte** — Please show me your passport  ·  **Malupad it eroplano alas nuybe** — The plane leaves at 9  ·  **Deritso ha gate numero dos** — Straight to gate number 2  ·  **Enjoy hit imo biyahe** — Enjoy your trip

### Plan a day trip  — _San Juanico & Sto. Niño_
- _Places & going out:_  **pamasyada** — outing / stroll  ·  **tulay** — bridge  ·  **lugar** — place  ·  **isla** — island  ·  **museo** — museum  ·  **pumpboat** — pump boat  ·  **makaradlok** — scary  ·  **mamasyada** — to go out / stroll  ·  **kumita** — to see / visit  ·  **maupod** — to come along  ·  **huram** — to borrow
- _Making the plan:_  **Pamasyada kita** — Let's go out  ·  **Mamamasyada ako buwas** — I'll go out tomorrow  ·  **Karuyag ko kumita** — I want to see it  ·  **Maupod ka buwas?** — Will you come along tomorrow?  ·  **Karuyag ko kumita hit San Juanico** — I want to see San Juanico  ·  **Pwede kita magburubaktas** — We can walk around there  ·  **Pagkita kita buwas** — Let's meet tomorrow  ·  **Mahusay ngadto** — It's beautiful there

### Cook a dish  — _In the kitchen_
- _Ingredients:_  **lasona** — garlic  ·  **sibuyas** — onion  ·  **suoy** — vinegar  ·  **toyo** — soy sauce  ·  **tubig** — water  ·  **pamyenta** — pepper  ·  **asukar** — sugar
- _Cooking words:_  **lutuon** — to cook (it)  ·  **igbabad** — to marinate  ·  **pakaladkara** — to boil (it)  ·  **panakot** — ingredients / spices  ·  **madali** — easy / quick  ·  **masayon** — easy / simple  ·  **makuri** — hard / difficult
- _Making adobo:_  **Ano ini nga kaluto?** — What dish is this?  ·  **Adobo nga manok** — Chicken adobo  ·  **Makuri ba ini lutuon?** — Is this hard to cook?  ·  **Madali la** — It's easy  ·  **Tutdui gad ako** — Please teach me  ·  **Ano it mga panakot?** — What are the ingredients?

### Food & the table  — _On the table_
...
- _God & worship:_  **Diyos** — God  ·  **Ginoo** — Lord  ·  **Jesu Kristo** — Jesus Christ  ·  **espiritu** — spirit  ·  **simba** — to worship  ·  **ampo** — to pray  ·  **wali** — to preach  ·  **bendisyon** — blessing  ·  **gugma** — love  ·  **kasingkasing** — heart

### Church & belief  — _Church life_
- _Church & belief:_  **iglesia** — church  ·  **pastor** — pastor  ·  **misyonaryo** — missionary  ·  **Kristohanon** — Christian  ·  **Bibliya** — Bible  ·  **kros** — cross  ·  **kinabuhi** — life  ·  **langit** — sky / heaven  ·  **pasaylo** — to forgive  ·  **kaadlawan** — birthday
