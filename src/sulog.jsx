...
const CURRICULUM = [
  ...
  { id: "u12", name: "Describing sentences", hint: "Saying 'the ___ is ___' with an / it", lessons: [
    ...
    { id: "u12l2", title: "The ___ is ___", items: ["Gwapo it bata", "Gwapo an bata", "Hataas it akon uyab", "Marasa it adobo", "Mabaho it jeep"] },
  ] },
  { id: "u13", name: "Verbs in action", hint: "Will / now / did, with mag- and nag-", lessons: [
    { id: "u13l1", title: "Cook: will, now, did", items: ["Magluluto it bata", "Nagluluto it bata", "Nagluto an bata"] },
  ] },
  ] },
  { id: "s3", name: "Out & About", hint: "Getting around and running errands", units: [
  ...
  { id: "u19", name: "Cooking", hint: "In the kitchen", lessons: [
    ...
    { id: "u19l2", title: "Cooking words", items: ["lutuon", "igbabad", "pakaladkara", "panakot", "madali", "masayon", "makuri"] },
    { id: "u19l3", title: "Making adobo", items: ["Ano ini nga kaluto?", "Adobo nga manok", "Makuri ba ini lutuon?", "Madali la", "Tutdui gad ako", "Ano it mga panakot?"] },
  ] },
