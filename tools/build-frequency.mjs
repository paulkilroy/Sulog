/* Phase 0 frequency builder — compute an attested Waray frequency "graph" from the
   ...
   Sources:
   - docs/sources/dictionaries/waray-first-1000-words-2013.txt  (Oyzon/CHED: the top-1000 SET +
     parseable dictionary entries with example sentences — the authoritative signal)
   - docs/sources/peace-corps/peace-corps-full-ocr.txt          (conversational Waray, graded)
   ...
   Outputs:
   - docs/courses/frequency/waray-frequency-graph.md   (human-readable report: ranked words, tiers, gap list)
   - docs/sources/dictionaries/waray-lexicon.json (normalized: sources, lexemes, cards, sentences)
...
const SRC = {
  ched: "docs/sources/dictionaries/waray-first-1000-words-2013.txt",
  peace: "docs/sources/peace-corps/peace-corps-full-ocr.txt",
  tramp: "docs/sources/dictionaries/tramp-zorc-waray-english-dictionary-1991.txt",
  ...
  bfc: "docs/sources/bfc-waray/bfc-waray-stories.txt",
  ...
  bloom: "docs/sources/bloom-waray/bloom-waray-stories.txt",
};
...
fs.writeFileSync(path.join(root, "docs/courses/frequency/waray-frequency-graph.md"), md);
...
`;
fs.writeFileSync(path.join(root, "docs/sources/corpus/waray-attested-sentences.md"), pool);
...
fs.writeFileSync(path.join(root, "docs/courses/frequency/waray-words-to-add.md"), add);
...
fs.writeFileSync(
  path.join(root, "docs/sources/dictionaries/waray-lexicon.json"),
  JSON.stringify({
    meta: {
