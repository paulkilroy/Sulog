...
fs.writeFileSync("docs/courses/challenger2/say-review.json", JSON.stringify(rp.flagged, null, 2));
console.log(`• ${rp.flagged.length} words flagged for Ella → docs/courses/challenger2/say-review.json`);
...
fs.writeFileSync("docs/courses/challenger2/phase1.json", JSON.stringify(P1, null, 2));
fs.writeFileSync("docs/courses/challenger2/phase2.json", JSON.stringify(P2, null, 2));
